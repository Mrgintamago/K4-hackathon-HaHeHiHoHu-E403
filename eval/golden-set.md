...
| # | Câu hỏi | Kỳ vọng |
|---:|---|---|
| 1 | `@bot Hôm qua học bài gì vậy?` | Bot trả lời dựa trên tối đa 3 trang đầu file `30.07.2026-ngay6.pdf`. Câu trả lời bằng tiếng Việt, tối đa 6 gạch đầu dòng, không chứa PII. |
...
| 4 | `@bot Bài học ngày 30.07.2026 nói về gì?` | Bot parse đúng ngày 30.07.2026, tìm file `30.07.2026-ngay6.pdf`, đọc tối đa 3 trang đầu và trả lời tóm tắt có căn cứ. |
| 5 | `@bot Cho mình xem nội dung bài ngày 30.07.2026` | Bot parse đúng ngày tuyệt đối `30.07.2026`, tìm đúng PDF và trả lời dựa trên tối đa 3 trang đầu. |
...
| 9 | `@bot Bài ngày 29.07.2026 là gì?` | Nếu thư mục `pdf/` có file `29.07.2026-ngay5.pdf`, bot đọc tối đa 3 trang đầu và trả lời tóm tắt có căn cứ. |
